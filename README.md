...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hsluv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8619&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hsluv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hsluv` can be installed with:

```
conda install hsluv
```

It is possible to list all of the versions of `hsluv` available on your platform with:
